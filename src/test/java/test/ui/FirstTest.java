...
public class FirstTest extends BaseTest {
    @Test
      /*
    TC: add steps
        0. Prerequisite: to have in the pom.xml property login.testcase.email an email that was already successfully registered to the website and the related name login.testcase.name
        1. Navigate to  
        2. Click th
        3. Click to Switch to 
        4. Insert the ...  and click submit to Login;
    ...
    */
    public void testLoginUser() throws Exception {
       ...
       //  RegisterLoginPopupPage registerLoginPopupPage = homePage.clickRegisterButton();
       // assertThat(registerLoginPopupPage.isUIinRegisterPanel()).isTrue().withFailMessage("Expected to be in the Registration panel, while it is not");
       ...
       // assertThat(registerLoginPopupPage.isUIinLoginPanel()).isTrue().withFailMessage("Expected to be in the Login panel, while it is not");
        ...
        System.out.println("4. Insert already registered email: " + registeredEmail + " named " + theName + " and click Submit to login" );
